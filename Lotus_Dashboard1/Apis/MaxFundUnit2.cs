...
namespace Lotus_Dashboard1.Apis
{
    ...
    [ApiController]
    public class MaxFundUnit2Controller : ControllerBase
    {

        private readonly IMemoryCache _memoryCache;

        public MaxFundUnit2Controller(IMemoryCache memoryCache)
        {
        ...
        public async Task<JsonResult> Get(string fundname)
        {
            ...
            if (fundname == "صندوق لوتوس")
            {
                ...
                var cacheKey1 = "dumpnavdateh";
                var cacheKey = "mostvalueh";
                string value2 = value11;

                var cacheKey3 = "latestnavdateh";
      ...
      " (select C##MAIN.T_CUSTOMER.COMPANY_NAME from C##MAIN.T_CUSTOMER where C##MAIN.T_CUSTOMER.NATIONAL_CODE= C##MAIN.PBF2_FUND_LICENSE.NATIONAL_CODE "+
  ...
  " (select C##MAIN.T_CUSTOMER.COMPANY_NAME from C##MAIN.T_CUSTOMER where C##MAIN.T_CUSTOMER.NATIONAL_CODE= C##MAIN.NNF3_FUND_LICENSE.NATIONAL_CODE " +
  " fetch first 1 rows only)" +
  ...
  " (select C##MAIN.T_CUSTOMER.COMPANY_NAME from C##MAIN.T_CUSTOMER where C##MAIN.T_CUSTOMER.NATIONAL_CODE= C##MAIN.PBF3_FUND_LICENSE.NATIONAL_CODE " +
  " fetch first 1 rows only)" +
  ...
  " where C##MAIN.PBF3_FUND_LICENSE.IS_CANCELLED=0 and C##MAIN.PBF3_FUND_LICENSE.FUND_UNIT>0 and length(C##MAIN.PBF3_FUND_LICENSE.NATIONAL_CODE)>10), " +
            ...
            if (fundname == "صندوق رویان")
            {
                ...
                string query1 = " with t1 as((select C##MAIN.PBF6_FUND_LICENSE.fund_unit as unit,'صندوق لوتوس' as fundname, " +
                  " C##MAIN.T_CUSTOMER.COMPANY_NAME as name2,C##MAIN.PBF6_FUND_LICENSE.NATIONAL_CODE as national1 from C##MAIN.PBF6_FUND_LICENSE " +
                  " inner join C##MAIN.T_CUSTOMER on C##MAIN.T_CUSTOMER.NATIONAL_CODE=C##MAIN.PBF6_FUND_LICENSE.NATIONAL_CODE  " +
                  " where C##MAIN.PBF6_FUND_LICENSE.IS_CANCELLED=0 and C##MAIN.PBF6_FUND_LICENSE.FUND_UNIT>0 and C##MAIN.t_customer.is_company=1)" +
  ...
  " (select C##MAIN.T_CUSTOMER.COMPANY_NAME from C##MAIN.T_CUSTOMER where C##MAIN.T_CUSTOMER.NATIONAL_CODE= C##MAIN.ZUF_FUND_LICENSE.NATIONAL_CODE " +
  " fetch first 1 rows only)" +
