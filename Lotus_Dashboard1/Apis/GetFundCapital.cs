...
namespace Lotus_Dashboard1.Apis
{
    ...
    [ApiController]
    public class GetFundCapital : ControllerBase
    {
        ...
        public async Task<JsonResult> GetData(string fundname,string cdate)
        {
            ...
            if (Convert.ToInt32(cdate.datetonumber()) <= Convert.ToInt32(api_date.datetonumber()))
            {
                ...
                if (fundname == "صندوق لوتوس" && cdate != null )
                {
                    ...
                    string query = "select C##MAIN.pbf2_FUND_NAV.fund_capital from C##MAIN.pbf2_FUND_NAV where C##MAIN.pbf2_FUND_NAV.calc_date=:id and rownum=1";
                ...
                if (fundname == "صندوق پیروزان" && cdate != null )
                {
                    ...
                    string query = "select C##MAIN.NNF3_FUND_NAV.fund_capital from C##MAIN.NNF3_FUND_NAV where C##MAIN.NNF3_FUND_NAV.calc_date=:id and rownum=1";
                ...
                if (fundname == "صندوق رویان" && cdate != null )
                {
                    ...
                    string query = "select C##MAIN.PBF6_FUND_NAV.fund_capital from C##MAIN.PBF6_FUND_NAV where C##MAIN.PBF6_FUND_NAV.calc_date=:id and rownum=1";
                ...
                if (fundname == "صندوق الزهرا" && cdate != null )
                {
                    ...
                    string query = "select C##MAIN.ZUF_FUND_NAV.fund_capital from C##MAIN.ZUF_FUND_NAV where C##MAIN.ZUF_FUND_NAV.calc_date=:id and rownum=1";
